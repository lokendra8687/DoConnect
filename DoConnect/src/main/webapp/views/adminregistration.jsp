...
<html>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0">
      <a class="btn btn-light my-2 my-sm-0 mr-1" type="submit" href="adminlogin">Login</a>
      <a class="btn btn-light my-2 my-sm-0" type="submit" href="adminregistration">Register</a>
    </form>
  </div>
</nav>
